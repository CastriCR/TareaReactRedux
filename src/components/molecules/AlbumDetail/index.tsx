...
import { fetchDetalle } from "../../../store/actions/AlbumDetail";
...
const AlbumDetail: React.FC = () => {
    ...
    const detalles = useSelector((state: IState) => state.AlbumDetail.albumDetail)
    const filterDetail = detalles.filter(albumDetail => albumDetail.albumId === id)
